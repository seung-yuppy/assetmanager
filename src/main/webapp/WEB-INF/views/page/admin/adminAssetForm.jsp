		...
		<div class="main-content">
			<div class="dashboard-container">
				<div class="content-wrapper">
						<h1 class="content-title">자산 추가</h1>
						<p class="content-description">자산 추가를 위해서 아래 양식을 작성하세요. 모든 필수 필드를 정확하게 기입해야 합니다.</p>
						<form id="purchaseRequestForm" action="#" method="post">
							...
							<h2 class="form-section-title">자산 정보</h2>
							...
							<div id="formInputArea">
								...
								<div class="form-row second-row">
									<div class="form-group price-group fixed-width-sm">
										...
										<input type="text" id="serialNum" name="serialNum" value="" required>
									</div>
								</div>
								<div class="form-group">
