	...
	<div class="app-layout">
		...
		<div class="main-content">
			...
			<div class="dashboard-container">
				<h1>반납 요청 목록</h1>
				<span>현재 처리 중인 모든 반납 요청의 목록을 확인하고 관리합니다.</span>
						...
						<div class="filter-controls">
							<div class="status-filter">
								...
								<select id="statusFilter" onchange="setBoardParam('status', this.value)">
									...
									<option value="pending" ${param.status == 'pending' ? 'selected' : ''}>반납중</option>
									<option value="FINAL_APPROVAL" ${param.status == 'FINAL_APPROVAL' ? 'selected' : ''}>반납됨</option>
								</select>
							</div>
