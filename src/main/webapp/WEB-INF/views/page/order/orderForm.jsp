						...
						<form id="purchaseRequestForm" action="#" method="post">
							<div class="form-row first-row">
								...
								<div class="form-group product-select-group">
									<label for="productNameSelect">제품명 <span
										...
										name="productNameSelect" required onchange="handleProductChange(this.value)">
								...
								<div class="form-group product-input-group" id="productInputGroup" style="display: none;">
							...
							<div class="form-row second-row">
								<div class="form-group price-group">
									<label for="price">가격 (단위: 원) <span class="required">*</span></label>
									<input type="number" id="price" name="price" value="0" readonly
										class="price-lock" required>
								</div>
								...
								<div class="form-group empty-filler-second-row"></div>
							</div>

							<div class="form-group">
								<label for="reason">구매 사유 <span class="required">*</span></label>
								<textarea id="reason" name="reason" rows="4" required placeholder="구매 요청이 필요한 구체적인 사유를 입력해주세요." maxlength="200" onkeyup="updateCharCount(this, 200)"></textarea>
								<div class="char-count-display">(<span id="currentLength">0</span> / 200) </div>
							</div>

							<div class="form-group checkbox-group">
								<input type="checkbox" id="isDepartmentUse"
									name="isDepartmentUse"> <label for="isDepartmentUse">부서
									공동 사용 자산입니다.</label>
								<p class="description">체크 시, 해당 자산은 특정 개인 소유가 아닌 부서 공동 자산으로
									등록됩니다.</p>
							</div>
